...
requirements = freetype, pandas, hostpython3, jpeg, libffi, openssl, png, sdl2_image, sdl2_mixer, sdl2_ttf==2.0.15, sqlite3, python3, sdl2, setuptools, pillow, six, pyjnius, android, kivy==2.1.0, kivymd==1.1.1, kivy_garden, requests, chardet, urllib3, idna, certifi, yfinance, asyncio,
...
# (list) Application requirements
# comma separated e.g. requirements = sqlite3,kivy
requirements = chatterbot,ntrt,regex,freetype, hostpython3, jpeg, libffi, openssl, png, sdl2_image, sdl2_mixer, sdl2_ttf==2.0.15, sqlite3, python3, sdl2, setuptools, pillow, six, pyjnius, android, kivy==2.1.0, kivymd==1.1.1, kivy_garden, requests, chardet, urllib3, idna, certifi, yfinance, asyncio,
