...
# (str) Application entry point (targeted module without the .py)
source.include_exts = py,png,jpg,kv,atlas
source.include_exts_deps = ttf,otf
main.source.dir = .

# (list) Application source files to include (let Kivy add things
# automatically)
source.include_exts = py,png,jpg,kv,atlas
source.include_exts_deps = ttf,otf

# (str) URL of your primary Git repository
source.include_exts = py,png,jpg,kv,atlas
source.include_exts_deps = ttf,otf
...
requirements = python3,hostpython==3,kivy2.1.0,pillow,yfinance,kivy_garden 
